...
An internal [JWT](https://jwt.io/introduction) bearer token generated by the Identity Service (Keycloak) will be consumed by both Alfresco Content Service and Alfresco Process Service.
